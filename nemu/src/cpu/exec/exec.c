...
/* 0x80 */
make_group(group1_b,
	add_i2rm_b, or_i2rm_b, adc_i2rm_b, inv, 
	and_i2rm_b, sub_i2rm_b, xor_i2rm_b,cmp_i2rm_b)

/* 0x81 */
make_group(group1_v,
	add_i2rm_v, or_i2rm_v, adc_i2rm_v, inv, 
...
make_group(group2_1_b,
	inv, inv, inv, inv, 
	shl_rm_1_v, shr_rm_1_b, inv, sar_rm_1_b)
...
/* 0xf6 */
make_group(group3_b,
	test_i2rm_b, inv, not_rm_b, mul_rm_b, 
	inv, imul_rm2a_b, inv, idiv_rm_b)

/* 0xf7 */
make_group(group3_v,
	test_i2rm_v, inv, not_rm_v, mul_rm_v, 
...
/* 0x74 */	je_i_b, jne_i_b, jbe_si_b, ja_i_b,
/* 0x78 */	js_i_b, jns_i_b, jp_i_b, jnp_i_b,
/* 0x7c */	jnge_i_b, jge_i_b, jle_i_b, jg_i_b,
...
/* 0xc0 */	group2_i_b, group2_i_v, inv, ret_v,
...
/* 0x84 */	je_i_v, jne_i_v, jbe_si_v, ja_i_v,
...
/* 0x98 */	sets_rm_b, setns_rm_b, setp_rm_b, setpo_rm_b, 
...
/* 0xb4 */	inv, inv, movzx_rm2r_b, movzx_rm2r_v, 
/* 0xb8 */	inv, inv, inv, inv,
/* 0xbc */	inv, inv, movsx_rm2r_b, movsx_rm2r_v,
